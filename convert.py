...
def generate_index(output_dir: str, files: List[str]):
    ...
    with open(readme_path, 'w', encoding='utf-8') as f:
        ...
        f.write("    url: \"https://raw.githubusercontent.com/cs3306/domain-list-clash/release/classical/google.yaml\"\n")
        ...
        f.write("    url: \"https://raw.githubusercontent.com/cs3306/domain-list-clash/release/domain/google.yaml\"\n")
        f.write("    path: ./ruleset/google.yaml\n")
        f.write("    interval: 86400\n\n")
        f.write("rules:\n")
        f.write("  - RULE-SET,google,PROXY\n")
